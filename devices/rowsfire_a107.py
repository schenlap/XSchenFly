...
def create_button_list_a107():
    ...
    #buttonlist.append(Button(50, "Bat1", MF_MP2, 15, "sim/cockpit2/electrical/battery_on", DREF_TYPE.ARRAY_0, BUTTON.TOGGLE))# gets overwirtten
    #buttonlist.append(Button(51, "Bat2", MF_MP2, 14, "sim/cockpit2/electrical/battery_on", DREF_TYPE.ARRAY_1, BUTTON.TOGGLE)) # toto bats volt read AirbusFBW/BatVolts
