...
def create_led_list_a107():  # TODO check sim/cockpit/electrical/avionics_on == 1
    ...
    ledlist.append(Led("FUEL_PUMP1_FAULT_LED", MF_SR1, 18, "AirbusFBW/FuelAutoPumpOHPArray", DREF_TYPE.ARRAY_2, "==3"))
    ledlist.append(Led("FUEL_PUMP2_OFF_LED", MF_SR1, 23, "AirbusFBW/FuelAutoPumpOHPArray", DREF_TYPE.ARRAY_3, "==0"))
    ledlist.append(Led("FUEL_PUMP2_FAULT_LED", MF_SR1, 22, "AirbusFBW/FuelAutoPumpOHPArray", DREF_TYPE.ARRAY_3, "==3"))
    ledlist.append(Led("FUEL_R_PUMP1_OFF_LED",  MF_SR1, 25, "AirbusFBW/FuelAutoPumpSDArray", DREF_TYPE.ARRAY_2, "==0"))
    ledlist.append(Led("FUEL_R_PUMP1_FAULT_LED", MF_SR1, 16, "AirbusFBW/FuelAutoPumpSDArray", DREF_TYPE.ARRAY_2, "==3"))
    ledlist.append(Led("FUEL_R_PUMP2_OFF_LED", MF_SR1, 27, "AirbusFBW/FuelAutoPumpSDArray", DREF_TYPE.ARRAY_3, "==0"))
    ledlist.append(Led("FUEL_R_PUMP2_FAULT_LED", MF_SR1, 26, "AirbusFBW/FuelAutoPumpSDArray", DREF_TYPE.ARRAY_3, "==3"))
