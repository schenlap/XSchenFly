...
def create_button_list_a107():
    ...
    buttonlist.append(Button("APU_BLEED", MF_MP1, 6, "AirbusFBW/APUBleedSwitch", DREF_TYPE.DATA, BUTTON.SWITCH))
    ...
    buttonlist.append(Button("Fire APU", MF_MP2, 0, None, DREF_TYPE.ARRAY_12, BUTTON.SWITCH))
    ...
    #buttonlist.append(Button("TCAS 2", MF_MP4, 12, None, DREF_TYPE.ARRAY_12, BUTTON.SWITCH_COMBINED))
...
def create_combined_button_list_a107():
    ...
    #combinedlist.append(Combined("TCAS_combined", ["TCAS 1", "TCAS 2"], [0, 1, 2, 3]))
