...
def create_led_list_a107():  # TODO check sim/cockpit/electrical/avionics_on == 1
    ...
    ledlist.append(Led(1, "APU_MASTER_ON_LED", MF_SR2, 11, "AirbusFBW/OHPLightsATA49_Raw", DREF_TYPE.ARRAY_0))
    ledlist.append(Led(1, "APU_MASTER_FAULT_LED", MF_SR2, 10, "AirbusFBW/OHPLightsATA49_Raw", DREF_TYPE.ARRAY_1))
    ...
    ledlist.append(Led(5, "AIR_APU_BLEED_ON_LED", MF_SR2, 7, "AirbusFBW/OHPLightsATA21_Raw", DREF_TYPE.ARRAY_4))
    #ledlist.append(Led(6, "AIR_APU_BLEED_FAULT_LED", MF_SR2, 6, None))
    ledlist.append(Led(7, "AIR_PACK1_BLEED_OFF_LED", MF_SR2, 5, "AirbusFBW/OHPLightsATA21_Raw", DREF_TYPE.ARRAY_6))
    ledlist.append(Led(8, "AIR_PACK1_BLEED_FAULT_LED", MF_SR2, 4, "AirbusFBW/OHPLightsATA21_Raw", DREF_TYPE.ARRAY_7))
    ledlist.append(Led(9, "AIR_PACK2_BLEED_OFF_LED", MF_SR2, 9, "AirbusFBW/OHPLightsATA21_Raw", DREF_TYPE.ARRAY_8))
    ledlist.append(Led(10, "AIR_PACK2_BLEED_FAULT_LED", MF_SR2, 0, "AirbusFBW/OHPLightsATA21_Raw", DREF_TYPE.ARRAY_9))
    ...
    ledlist.append(Led(21, "ELEC_BAT1_OFF_LED", MF_SR1, 28, "AirbusFBW/BatOHPArray", DREF_TYPE.ARRAY_0, "not($&1)"))
    ledlist.append(Led(22, "ELEC_BAT1_FAULT_LED", MF_SR1, 29, "AirbusFBW/BatOHPArray", DREF_TYPE.ARRAY_0, "==3"))
    ledlist.append(Led(23, "ELEC_BAT2_OFF_LED", MF_SR1, 30, "AirbusFBW/BatOHPArray", DREF_TYPE.ARRAY_1, "not($&1)"))
    ...
    ledlist.append(Led(27, "FUEL_L_PUMP1_OFF_LED",  MF_SR1, 15,"AirbusFBW/FuelAutoPumpSDArray", DREF_TYPE.ARRAY_0, "==0"))
    ledlist.append(Led(28, "FUEL_L_PUMP1_FAULT_LED", MF_SR1, 14, "AirbusFBW/FuelAutoPumpSDArray", DREF_TYPE.ARRAY_0, "==3"))
    ledlist.append(Led(29, "FUEL_L_PUMP2_OFF_LED",  MF_SR1, 17, "AirbusFBW/FuelAutoPumpSDArray", DREF_TYPE.ARRAY_1, "==0"))
    ledlist.append(Led(30, "FUEL_L_PUMP2_FAULT_LED", MF_SR1, 8, "AirbusFBW/FuelAutoPumpSDArray", DREF_TYPE.ARRAY_1, "==3"))
    ledlist.append(Led(31, "FUEL_PUMP1_OFF_LED", MF_SR1, 19, "AirbusFBW/FuelAutoPumpOHPArray", DREF_TYPE.ARRAY_2, "==0"))
    ledlist.append(Led(32, "FUEL_PUMP1_FAULT_LED", MF_SR1, 18, "AirbusFBW/FuelAutoPumpSDArray", DREF_TYPE.ARRAY_2, "==3"))
    ledlist.append(Led(31, "FUEL_PUMP2_OFF_LED", MF_SR1, 23, "AirbusFBW/FuelAutoPumpOHPArray", DREF_TYPE.ARRAY_3, "==0"))
    ledlist.append(Led(32, "FUEL_PUMP2_FAULT_LED", MF_SR1, 22, "AirbusFBW/FuelAutoPumpSDArray", DREF_TYPE.ARRAY_3, "==3"))
    ledlist.append(Led(33, "FUEL_R_PUMP1_OFF_LED",  MF_SR1, 25, "AirbusFBW/FuelAutoPumpSDArray", DREF_TYPE.ARRAY_4, "==0"))
    ledlist.append(Led(34, "FUEL_R_PUMP1_FAULT_LED", MF_SR1, 16, "AirbusFBW/FuelAutoPumpSDArray", DREF_TYPE.ARRAY_4, "==3"))
    ledlist.append(Led(35, "FUEL_R_PUMP2_OFF_LED", MF_SR1, 27, "AirbusFBW/FuelAutoPumpSDArray", DREF_TYPE.ARRAY_5, "==0"))
    ledlist.append(Led(36, "FUEL_R_PUMP2_FAULT_LED", MF_SR1, 26, "AirbusFBW/FuelAutoPumpSDArray", DREF_TYPE.ARRAY_5, "==3"))
    ledlist.append(Led(37, "FUEL_MODE_SEL_MAN_LED", MF_SR1, 21, "AirbusFBW/FuelOHPArray", DREF_TYPE.ARRAY_6, "==0"))
...
def create_button_list_a107():
    ...
    buttonlist.append(Button(0, "APU_MASTER", MF_MP1, 4, "AirbusFBW/APUMaster", DREF_TYPE.DATA, BUTTON.SWITCH_INVERSE))
    ...
    buttonlist.append(Button(17, "Ice Eng1 On", MF_MP1, 1, "toliss_airbus/antiicecommands/ENG1On", DREF_TYPE.CMD, BUTTON.SWITCH_INVERSE))
    buttonlist.append(Button(17, "Ice Eng1 Off", MF_MP1, 1, "toliss_airbus/antiicecommands/ENG1Off", DREF_TYPE.CMD, BUTTON.SWITCH))
    buttonlist.append(Button(18, "Ice Eng2 On", MF_MP1, 0, "toliss_airbus/antiicecommands/ENG2On", DREF_TYPE.CMD, BUTTON.SWITCH_INVERSE))
    buttonlist.append(Button(18, "Ice Eng2 Off", MF_MP1, 0, "toliss_airbus/antiicecommands/ENG2Off", DREF_TYPE.CMD, BUTTON.SWITCH))
    buttonlist.append(Button(19, "Ice Wing On", MF_MP1, 2, "toliss_airbus/antiicecommands/WingOn", DREF_TYPE.CMD, BUTTON.SWITCH_INVERSE))
    buttonlist.append(Button(19, "Ice Wing Off", MF_MP1, 2, "toliss_airbus/antiicecommands/WingOff", DREF_TYPE.CMD, BUTTON.SWITCH))
    buttonlist.append(Button(20, "Pack1 On", MF_MP1, 7, "toliss_airbus/aircondcommands/Pack1On", DREF_TYPE.CMD, BUTTON.SWITCH))
    buttonlist.append(Button(20, "Pack1 Off", MF_MP1, 7, "toliss_airbus/aircondcommands/Pack1Off", DREF_TYPE.CMD, BUTTON.SWITCH_INVERSE))
    buttonlist.append(Button(21, "Pack2 On", MF_MP1, 5, "toliss_airbus/aircondcommands/Pack2On", DREF_TYPE.CMD, BUTTON.SWITCH))
    buttonlist.append(Button(21, "Pack2 Off", MF_MP1, 5, "toliss_airbus/aircondcommands/Pack2Off", DREF_TYPE.CMD, BUTTON.SWITCH_INVERSE))
    buttonlist.append(Button(22, "Fire APU", MF_MP2, 0, None, DREF_TYPE.ARRAY_12, BUTTON.SWITCH))
    buttonlist.append(Button(23, "Fire Eng1", MF_MP2, 1, "AirbusFBW/ENGFireSwitchArray", DREF_TYPE.ARRAY_0, BUTTON.SWITCH))
    buttonlist.append(Button(24, "Fire Eng2", MF_MP3, 15, "AirbusFBW/ENGFireSwitchArray", DREF_TYPE.ARRAY_1, BUTTON.SWITCH))
    buttonlist.append(Button(25, "Fire Test APU", MF_MP2, 4, "AirbusFBW/FireTestAPU", DREF_TYPE.CMD, BUTTON.SWITCH_INVERSE))
    buttonlist.append(Button(26, "Fire Test Eng1", MF_MP2, 5, "AirbusFBW/FireTestENG1", DREF_TYPE.CMD, BUTTON.SWITCH_INVERSE))
    buttonlist.append(Button(27, "Fire Test Eng2", MF_MP2, 3, "AirbusFBW/FireTestENG2", DREF_TYPE.CMD, BUTTON.SWITCH_INVERSE))
    ...
    buttonlist.append(Button(43, "Pump1", MF_MP2, 10, "AirbusFBW/FuelOHPArray", DREF_TYPE.ARRAY_2, BUTTON.SWITCH))
    buttonlist.append(Button(44, "Pump2", MF_MP2, 8, "AirbusFBW/FuelOHPArray", DREF_TYPE.ARRAY_3, BUTTON.SWITCH))
    buttonlist.append(Button(45, "Left Pump1", MF_MP2, 12, "AirbusFBW/FuelOHPArray", DREF_TYPE.ARRAY_0, BUTTON.SWITCH))
    buttonlist.append(Button(46, "Left Pump2", MF_MP2, 11, "AirbusFBW/FuelOHPArray", DREF_TYPE.ARRAY_1, BUTTON.SWITCH))
    buttonlist.append(Button(47, "Pump Modesel", MF_MP2, 9, "AirbusFBW/FuelOHPArray", DREF_TYPE.ARRAY_6, BUTTON.SWITCH))
    buttonlist.append(Button(48, "Right Pump1", MF_MP2, 7, "AirbusFBW/FuelOHPArray", DREF_TYPE.ARRAY_4, BUTTON.SWITCH))
    buttonlist.append(Button(48, "Right Pump2", MF_MP2, 6, "AirbusFBW/FuelOHPArray", DREF_TYPE.ARRAY_5, BUTTON.SWITCH))
    #buttonlist.append(Button(50, "Bat1", MF_MP2, 15, "sim/cockpit2/electrical/battery_on", DREF_TYPE.ARRAY_0, BUTTON.SWITCH))# gets overwirtten
    #buttonlist.append(Button(51, "Bat2", MF_MP2, 14, "sim/cockpit2/electrical/battery_on", DREF_TYPE.ARRAY_1, BUTTON.SWITCH)) # toto bats volt read AirbusFBW/BatVolts
    #buttonlist.append(Button(52, "APU Gen", MF_MP1, 8, "AirbusFBW/APUGenOHPArray", DREF_TYPE.ARRAY_0, BUTTON.SWITCH)) # gen array is read only
    buttonlist.append(Button(53, "IR1", MF_MP1, 13, None, DREF_TYPE.ARRAY_12, BUTTON.SWITCH))
    buttonlist.append(Button(54, "IR2", MF_MP1, 12, None, DREF_TYPE.ARRAY_12, BUTTON.SWITCH))
    buttonlist.append(Button(55, "IR3", MF_MP1, 11, None, DREF_TYPE.ARRAY_12, BUTTON.SWITCH))
